...
```{r adjacency200, eval=FALSE}
PotentialForest <- terra::vect("potentialForest200ha_SF.shp")

AB_200 <- terra::vect("AB_200.shp")

Test <- sf::st_touches(st_as_sf(terra::buffer(PotentialForest[1,],)), st_as_sf(AB_200))

Test <- terra::nearby(PotentialForest[1:300,], AB_200,  distance = 50, centroids = F, symmetrical = F)
```
